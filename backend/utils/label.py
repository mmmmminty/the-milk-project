...
def label_maker(mother_id, mother_name = "", baby_name = "", mrn = "", embedded_image_name = None):
    a4_x = 7000
    a4_y = 5000
    ...
    a4.save(f"./images/a4_label_page.png")

if (__name__ == "__main__"):
    label_maker("mother1", mother_name = "Mother_Name")
